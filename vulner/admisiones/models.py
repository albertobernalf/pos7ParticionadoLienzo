...
#class Ingresos(PostgresPartitionedModel):
    ...
    autorizacionesHospitalDetalle = models.ForeignKey('autorizaciones.AutorizacionesDetalle', blank=True,null= True, editable=True, on_delete=models.PROTECT ,   related_name='autHosp01')
    autorizacionesConsultaDetalle = models.ForeignKey('autorizaciones.AutorizacionesDetalle', blank=True,null= True, editable=True, on_delete=models.PROTECT ,   related_name='autCons01')
    autorizacionesAmbDetalle = models.ForeignKey('autorizaciones.AutorizacionesDetalle', blank=True,null= True, editable=True, on_delete=models.PROTECT ,   related_name='autAmb01')
    autorizacionesUrgenciasDetalle = models.ForeignKey('autorizaciones.AutorizacionesDetalle', blank=True,null= True, editable=True, on_delete=models.PROTECT ,   related_name='autUrg01')
