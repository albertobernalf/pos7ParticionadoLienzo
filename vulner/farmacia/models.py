...
class FarmaciaDetalle(PostgresPartitionedModel):
...
#class FarmaciaDespachos(PostgresPartitionedModel):
    ...
    #class Meta:
    #    unique_together = (('id', 'fechaRegistro'),)
...
#class FarmaciaDespachosDispensa(PostgresPartitionedModel):
